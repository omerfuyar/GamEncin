...
#define GE_SSBO_MODEL_MATRICES_BINDING 0
#define GE_SSBO_TEXTURE_HANDLES_BINDING 1

#define GE_VBO_OBJECT_ID_LAYOUT 0
#define GE_VBO_POSITION_LAYOUT 1
#define GE_VBO_NORMAL_LAYOUT 2
#define GE_VBO_UV_LAYOUT 3
