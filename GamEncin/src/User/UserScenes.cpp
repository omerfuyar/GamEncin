...
#pragma endregion
    ...
    /*
        ...
        DialoguePiece *firstAreaDP = new DialoguePiece("The air is heavy. The stone walls\nhum with a pulse not heard in ages.\nIn the center, there is a wise-looking man...\nStanding.", continueDO);
        ...
        //------------oracle base
        NPC *npc = oracleObj.AddComponent<NPC>();
        ...
        Dialogue *oracleFinalD = new Dialogue("Oracle Final", endQuestionDP, PlayerDialogueState::AfterFirstAreaTrigger);
        // todo npc->AddDialogue(PlayerDialogueState::AfterFirstAreaTrigger, oracleFinalD);
        */
    ...
    DialoguePiece* wrongDP = new DialoguePiece("Wrong. Looks like you are not ready to proceed.", quitDO);
    ...
    DialoguePiece* oracleAwakenDP = new DialoguePiece(
        "You get your goosebumps as the man looks at you.\nThe wise man speaks — voice calm, yet echoing.", continueDO);
    Dialogue* oracleAwakenD = new Dialogue("Oracle Awakens", oracleAwakenDP, PlayerDialogueState::AfterOracleAwakens);
    oracle->AddDialogue(PlayerDialogueState::AfterFirstAreaTrigger, oracleAwakenD);
