...
/// @ingroup gtx
///
/// Include <glm/gtx/uv.hpp> to use the features of this extension.
///
...
namespace glm
{
    ...
    /// Compute the number of mipmaps levels necessary to create a mipmap complete uv
    ///
    /// @param Extent Extent of the uv base level mipmap
